...
SimpleNavigation::Configuration.run do |navigation|
  ...
  navigation.items do |primary|
    ...
    primary.item :tournament, I18n.t("sport_centers.show.tournaments"),'#', :icon =>['icon-star'] do |tournaments|
      tournaments.item :show, I18n.t("sport_centers.show.see_tournaments"), sport_center_leagues_path(@sport_center)
